                        ...
                        <div class="tab-content">
                                    ...
                                    <div class="login-register-form">
                                        <form action="#" method="post">
                                            ...
                                            <div class="button-box">
                                                ...
                                                <button type="submit"><span>登入</span></button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                            ...
                            <div id="lg2" class="tab-pane">
                                <div class="login-form-container">
                                    <div class="login-register-form">
                                        <form action="#" method="post">
                                            <p>姓名<input type="text" name="user-name" ></p>
                                            <p>性別<select name="sex"><option>男<option>女</select></p>
                                            <p>身分證字號<input type="text" name="user-ID" ></p>
                                            <p>生日<input type="date" name="user-birthday" ></p>
                                            <p>手機<input type="text" name="user-phone" ></p>
                                            <p>地址<select id="city">
                                            ...
                                            <script>
                                                const obj = {
                                                    ...
                                                    '新北市': ['台北縣', '207萬里鄉', '208金山鄉', '220板橋市', '221汐止市', '222深坑鄉', '223石碇鄉', '224瑞芳鎮', '226平溪鄉', '227雙溪鄉', '228貢寮鄉', '231新店市', '232坪林鄉', '233烏來鄉', '234永和市', '235中和市', '236土城市', '237三峽鎮', '238樹林市', '239鶯歌鎮', '241三重市', '242新莊市', '243泰山鄉', '244林口鄉', '247蘆洲市', '248五股鄉', '248新莊市', '249八里鄉', '251淡水鎮', '252三芝鄉', '253石門鄉'],
                                                    '桃園市': ['桃園縣', '320中壢市', '324平鎮市', '325龍潭鄉', '326楊梅鎮', '327新屋鄉', '328觀音鄉', '330桃園市', '333龜山鄉', '334八德市', '335大溪鎮', '336復興鄉', '337大園鄉', '338蘆竹鄉'],
                                                    '新竹市': ['300北區', '300東區', '300香山區', '300寶山鄉', '302竹北市', '303湖口鄉', '304新豐鄉', '305新埔鎮', '306關西鎮', '307芎林鄉', '308寶山鄉', '310竹東鎮', '311五峰鄉', '312橫山鄉', '313尖石鄉', '314北埔鄉', '315峨眉鄉'],
                                                    ...
                                                    '嘉義市': ['600西區', '600東區','602番路鄉', '603梅山鄉', '604竹崎鄉', '605阿里山鄉', '606中埔鄉', '607大埔鄉', '608水上鄉', '611鹿草鄉', '612太保市', '613朴子市', '614東石鄉', '615六腳鄉', '616新港鄉', '621民雄鄉', '622大林鎮', '623溪口鄉', '624義竹鄉', '625布袋鎮'],
                                                ...
                                                document.querySelector('#city').addEventListener('change', e => {
                                                    const stationArr = obj[e.target.value];
                                                    station.innerHTML = '';
                                                    for (let item of stationArr) {
                                                        station.innerHTML += `<option value="${item}">${item}</option>`;
                                                    }
                                                });
                                            </script><input type="text" name="user-address" ></p>
                                            <p>帳號<input type="text" name="user-account" ></p>
                                            <p>密碼<input type="password" name="user-password" ></p>
                                            <p>Email<input name="user-email" type="email"></p>
                                            <div class="button-box">
                                                <button type="submit"><span>註冊</span></button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
